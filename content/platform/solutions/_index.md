---
title: Solutions
description: With over 20 unique problem-solving verticals, Oswald Labs is the world's most versatile company in accessibility. Learn more about Oswald Labs' solutions.
---
...
<section>
	<div class="container pt-3 pt-md-0">
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<a href="/solutions/blind-read-aloud" class="card card-body d-block">
					<i class="fas fa-play-circle fa-fw fa-2x mr-2 text-muted"></i>
					<span>Read aloud for the blind</span>
				</a>
			</div>
			<div class="col-md-4 mb-4">
				<a href="/solutions/blind-friendly-read-aloud" class="card card-body d-block">
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<a href="/solutions/deaf-live-subtitles" class="card card-body d-block">
					<i class="fas fa-deaf fa-fw fa-2x mr-2 text-muted"></i>
					<span>Live subtitles for hearing impaired</span>
				</a>
			</div>
			<div class="col-md-4 mb-4">
				<a href="/solutions/books-for-dyslexic-students" class="card card-body d-block">
					<i class="fas fa-book-open fa-fw fa-2x mr-2 text-muted"></i>
					<span>Books for dyslexic students</span>
				</a>
			</div>
			<div class="col-md-4 mb-4">
				<a href="/solutions/blind-object-detection" class="card card-body d-block">
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<a href="/solutions/usability-testing" class="card card-body d-block">
					<i class="fas fa-flask fa-fw fa-2x mr-2 text-muted"></i>
					<span>Usability testing</span>
				</a>
			</div>
			<div class="col-md-4 mb-4">
				<a href="/solutions/employee-accessibility-training" class="card card-body d-block">
					<i class="fas fa-chalkboard-teacher fa-fw fa-2x mr-2 text-muted"></i>
					<span>Employee accessibility training</span>
				</a>
			</div>
			<div class="col-md-4 mb-4">
				<a href="/solutions/live-accessibility-consultancy" class="card card-body d-block">
					<i class="fas fa-headset fa-fw fa-2x mr-2 text-muted"></i>
					<span>Live accessibility consultancy</span>
				</a>
			</div>
			<div class="col-md-4 mb-4">
				<a href="/solutions/web-and-app-development" class="card card-body d-block">
